...
class AlgorithmicReverse:
    ...
    def __init__(self, task_length=10):
        LOGGER.info("Initializing algorithmic reverse task with a length of {}".format(task_length))
    ...
    def submit_solution(self, solution: Callable):
        LOGGER.debug("Evaluating solution {}".format(solution))

        solution_string = solution(self.task)[::-1]
